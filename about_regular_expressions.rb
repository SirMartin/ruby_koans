...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_parentheses_also_capture_matched_content_by_number
    ...
    assert_equal "Sanchez", "Gray, James, Sanchez"[/(\w+), (\w+), (\w+)/, 3]
    assert_equal nil, "Gray, James, Sanchez, Romero"[/(\w+), (\w+), (\w+), (\w+)/, 5]
    assert_equal "Gomez", "Gray, James, Sanchez, Romero, Gomez"[/(\w+), (\w+), (\w+), (\w+), (\w+)/, 5]
  end
